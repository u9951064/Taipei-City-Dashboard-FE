...
export const useMapStore = defineStore("map", {
	...
	actions: {
		...
		addMapLayerSource(map_config, data) {
			...
			if (map_config.index === customMapIndex.bubbleDonutChart) {
				this.circleDonutChartMap.setupDataSource(this.map, map_config, data);
			} else {
		...
		addMapLayer(map_config) {
			...
			if (map_config.index === customMapIndex.bubbleDonutChart) {
				...
				this.circleDonutChartMap.setupStyleLayerAndDonutChart(extra_paint_configs, extra_layout_configs);
